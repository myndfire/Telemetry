...
#>nssm install Prometheus-2.17.2  F:\Prometheus\prometheus-2.17.2.windows-amd64\prometheus.exe --web.enable-admin-api --storage.tsdb.retention.time=12d --storage.tsdb.path=C:\WK\SureTax\Tools\Data\Prometheus
#
#Install grafana
#modify defaults.ini
